...
import (
	...
	mockwk "github.com/yuttana76/simbplebank/worker/mock"
	"google.golang.org/grpc/codes"
	"google.golang.org/grpc/status"
)

// Custom Matcher for CreateUserParams
// ***********************************************
...
func (expected eqCreateUserTxParamsMatcher) Matches(x interface{}) bool {
	...
	if !reflect.DeepEqual(expected.arg.CreateUserParams, actualArg.CreateUserParams) {
		// fmt.Println(">> not equal", expected.arg.CreateUserParams, actualArg.CreateUserParams)
		return false
	}
	...
	testCase := []struct {
		...
		},
		{
			...
			checkResponse: func(t *testing.T, res *pb.CreateUserResponse, err error) {
				...
				require.Contains(t, st.Message(), "failed to create user")
			},
		},
		{
