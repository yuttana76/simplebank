...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		// goroutines : concurrent transactions function
	...
	for i := 0; i < n; i++ {
		...
		require.True(t, diff1%amount == 0) // check amount is multiple of transfer amount ;1 * amount, 2 * amount,3 * amount, ...,n *amount
